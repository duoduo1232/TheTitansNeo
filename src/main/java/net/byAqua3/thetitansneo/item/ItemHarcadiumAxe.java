...
public class ItemHarcadiumAxe extends AxeItem {

	public ItemHarcadiumAxe(Properties properties) {
		super(TheTitansNeoTiers.HARCADIUM, 49, -3.0F, properties.axe(TheTitansNeoTiers.HARCADIUM, 49, -3.0F));
	}
	...
	public void hurtEnemy(ItemStack stack, LivingEntity entity, LivingEntity attacker) {
		if (entity != null) {
			if (entity.getBbHeight() >= 6.0F || entity instanceof EntityTitan || !entity.onGround()) {
				...
				entity.hurtServer((ServerLevel) entity.level(), entity.damageSources().mobAttack(attacker), 450.0F);
			}
		}
