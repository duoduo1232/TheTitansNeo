...
public class EntityBlazePowderTitan extends AbstractHurtingProjectile implements IEntityProjectileTitan, ItemSupplier {

	public EntityBlazePowderTitan(EntityType<? extends EntityBlazePowderTitan> entityType, Level level) {
		super(entityType, level);
	}

	public EntityBlazePowderTitan(Level level, LivingEntity shooter) {
		super(TheTitansNeoEntities.BLAZE_POWDER_TITAN.get(), level);
