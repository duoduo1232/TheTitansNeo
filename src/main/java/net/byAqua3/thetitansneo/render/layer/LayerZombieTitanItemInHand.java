...
@OnlyIn(Dist.CLIENT)
public class LayerZombieTitanItemInHand extends RenderLayer<TitanRenderState, ModelZombieTitan> {

	public LayerZombieTitanItemInHand(RenderLayerParent<TitanRenderState, ModelZombieTitan> renderer) {
		super(renderer);
	}
	...
	public void submit(PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int lightCoords, TitanRenderState state, float yRot, float xRot) {
		...
		Identifier texture = Identifier.tryBuild(TheTitansNeo.MODID, "item/iron_sword_256");
