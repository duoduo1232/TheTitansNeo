...
public class RenderOptimaAxe implements IItemRenderer {
	...
	public void submit(ItemStack stack, ItemDisplayContext context, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int packedLight, int packedOverlay, boolean hasFoil, int outlineColor) {
		...
		case FIRST_PERSON_RIGHT_HAND:
			...
			submitNodeCollector.submitModel(axeModel, null, poseStack, packedLight, packedOverlay, -1, spriteId, this.sprites, outlineColor, null);
			poseStack.popPose();
			break;
	...
	public static final class Unbaked implements SpecialModelUnbaked {
		...
		public static final MapCodec<RenderOptimaAxe.Unbaked> MAP_CODEC = MapCodec.unit(new RenderOptimaAxe.Unbaked());

		@Override
		public MapCodec<RenderOptimaAxe.Unbaked> type() {
			return MAP_CODEC;
		}
