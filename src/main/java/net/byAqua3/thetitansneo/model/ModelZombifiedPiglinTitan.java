...
public class ModelZombifiedPiglinTitan extends EntityModel<TitanRenderState> {
	...
	public static LayerDefinition createBodyLayer(float grow) {
		...
		partDefinition.getChild("torso").getChild("middleBody").getChild("topBody").addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -8.0F, -4.0F, 10.0F, 8.0F, 8.0F, cubeDeformation).texOffs(31, 1).addBox(-2.0F, -4.0F, -5.0F, 4.0F, 4.0F, 1.0F, cubeDeformation).texOffs(2, 4).addBox(2.0F, -2.0F, -5.0F, 1.0F, 2.0F, 1.0F, cubeDeformation).texOffs(2, 0).addBox(-3.0F, -2.0F, -5.0F, 1.0F, 2.0F, 1.0F, cubeDeformation), PartPose.offsetAndRotation(0.0F, -4.0F, 0.0F, 0.0F, 0.0F, 0.0F));
		partDefinition.getChild("torso").getChild("middleBody").getChild("topBody").getChild("head").addOrReplaceChild("leftEar", CubeListBuilder.create().texOffs(51, 6).addBox(0.0F, 0.0F, -2.0F, 1.0F, 5.0F, 4.0F, cubeDeformation), PartPose.offsetAndRotation(4.5F, -6.0F, 0.0F, 0.0F, 0.0F, -Mth.PI / 6.0F));
		partDefinition.getChild("torso").getChild("middleBody").getChild("topBody").getChild("head").addOrReplaceChild("rightEar", CubeListBuilder.create().texOffs(39, 6).addBox(-1.0F, 0.0F, -2.0F, 1.0F, 5.0F, 4.0F, cubeDeformation), PartPose.offsetAndRotation(-4.5F, -6.0F, 0.0F, 0.0F, 0.0F, Mth.PI / 6.0F));
	...
	public void animate(EntityZombifiedPiglinTitan entity, float limbSwing, float limbSwingAmount, float ageInTicks, float headYaw, float headPitch) {
		...
		if (entity.deathTicks <= 0) {
			...
			if (entity.isPassenger()) {
				...
				this.rightCalf.xRot = Mth.cos(limbSwing * fo + 3.1415927F) * 0.75F * limbSwingAmount;
